...
@WebServlet("/AdicionarEnderecoCheckouServlet")
public class AdicionarEnderecoCheckout  extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.sendRedirect(request.getContextPath() + "/ListarEnderecosCheckout");
    }
}
